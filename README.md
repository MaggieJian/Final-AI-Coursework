...
Image: Mask of the location of interest showing urban roads (white) against urban nature (black).
...
Summary of the results: The ViT model produced a better cross-validation score and was favoured in the model selection compared to the CNN and Random Forest models. Mean cross-validation score:  0.844453410931932. When using the best parameters found during the search, the corresponding mean cross-validation score was 84.71%.
...
After comparing the models, the mean cross-validation score was 0.844453410931932. This means that the models performed with good (84.45%) accuracy on average across multiple validation iterations across different subsets of the training data.
...
After completing the unsupervised learning extension, the following result was produced.
